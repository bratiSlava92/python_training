...
class TestAddContact(unittest.TestCase):
    ...
    def create_new_contact(self, wd):
        ...
        wd.find_element_by_name("title").send_keys("ceo")
        wd.find_element_by_name("company").click()
        wd.find_element_by_name("company").clear()
        wd.find_element_by_name("company").send_keys("sber")
        wd.find_element_by_name("address").click()
        wd.find_element_by_name("address").clear()
        wd.find_element_by_name("address").send_keys("address")
        wd.find_element_by_name("home").click()
        wd.find_element_by_name("home").clear()
        wd.find_element_by_name("home").send_keys("8125556677")
        wd.find_element_by_name("mobile").click()
        wd.find_element_by_name("mobile").clear()
        wd.find_element_by_name("mobile").send_keys("89998887766")
        wd.find_element_by_name("theform").click()
        wd.find_element_by_name("work").click()
        wd.find_element_by_name("work").clear()
        wd.find_element_by_name("work").send_keys("8123334455")
        wd.find_element_by_name("fax").click()
        wd.find_element_by_name("fax").clear()
        wd.find_element_by_name("fax").send_keys("8123344455")
        ...
        wd.find_element_by_xpath("(//option[@value='25'])[2]").click()
        ...
        wd.find_element_by_name("phone2").send_keys("home123")
